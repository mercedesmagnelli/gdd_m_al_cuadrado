...
/* TABLA - NOMBRE SIGNIFICATIVO - ATRIBUTO FK DE LA TABLA - REFERENCIA A QUE TABLA Y ATRIBUTO */
ALTER TABLE prueba_primer ADD CONSTRAINT FK_REFERENTE_ID FOREIGN KEY (REFERENTE_ID) REFERENCES PRUEBA_REFERENTE (REFERENTE_ID)
...
ALTER TABLE M_AL_CUBO.COMPRA ADD CONSTRAINT FK_COMPRA_MEDIO_PAGO FOREIGN KEY (COMPRA_MEDIO_PAGO) REFERENCES M_AL_CUBO.MEDIO_PAGO (MEDIO_PAGO_ID)
GO

ALTER TABLE M_AL_CUBO.COMPRA ADD CONSTRAINT FK_DESCUENTO_COMPRA_ID FOREIGN KEY (COMPRA_DESCUENTO_ID) REFERENCES M_AL_CUBO.DESCUENTO_COMPRA (COMPRA_DESCUENTO_ID)
GO

ALTER TABLE M_AL_CUBO.PROVEEDOR ADD CONSTRAINT FK_LOCALIDAD_ID FOREIGN KEY (PROVEEDOR_ID) REFERENCES M_AL_CUBO.LOCALIDAD (LOCALIDAD_ID)
GO
...
ALTER TABLE M_AL_CUBO.CLIENTE ADD CONSTRAINT FK_CLIENTE_LOCALIDAD_ID FOREIGN KEY (CLIENTE_LOCALIDAD_ID) REFERENCES M_AL_CUBO.LOCALIDAD (LOCALIDAD_ID)
GO

ALTER TABLE M_AL_CUBO.TIPO_VARIANTE ADD CONSTRAINT FK_PRODUCTO_VARIANTE_CODIGO FOREIGN KEY (PRODUCTO_VARIANTE_CODIGO) REFERENCES M_AL_CUBO.VARIANTE (VARIANTE_ID_CODIGO)
GO
...
ALTER TABLE M_AL_CUBO.MEDIO_PAGO_VENTAS ADD CONSTRAINT FK_VENTA_ID FOREIGN KEY (VENTA_ID) REFERENCES M_AL_CUBO.VENTA (VENTA_ID)
GO
...
ALTER TABLE M_AL_CUBO.VENTA ADD CONSTRAINT FK_VENTA_MEDIO_PAGO_ID FOREIGN KEY (VENTA_MEDIO_PAGO_ID) REFERENCES M_AL_CUBO.MEDIO_PAGO_VENTAS (MEDIO_PAGO_ID)
GO
...
ALTER TABLE M_AL_CUBO.CANAL_VENTA ADD CONSTRAINT FK_CANAL_VENTA_ID FOREIGN KEY (CANAL_VENTA_ID) REFERENCES M_AL_CUBO.CANAL (CANAL_ID)
GO

/* CUPON X VENTA NO SE SI ESTA BIEN*/
...
/* IDEM PARA DESCUENTO X VENTA*/

ALTER TABLE M_AL_CUBO.DESCUENTO_X_VENTA ADD CONSTRAINT FK_DESCUENTO_ID FOREIGN KEY (DESCUENTO_ID) REFERENCES M_AL_CUBO.DESCUENTO (DESCUENTO_ID)
GO

ALTER TABLE M_AL_CUBO.DESCUENTO_X_VENTA ADD CONSTRAINT FK_VENTA_ID FOREIGN KEY (VENTA_ID) REFERENCES M_AL_CUBO.VENTA (VENTA_ID)
GO

-- Chequear porque me genero dudas
--Producto_x_variante_x_compra
ALTER TABLE M_AL_CUBO.PRODUCTO_X_VARIANTE_X_COMPRA ADD CONSTRAINT PRODUCTO_X_VAR_ID FOREIGN KEY (PRODUCTO_ID) REFERENCES M_AL_CUBO.PRODUCTO_X_VARIANTE (PRODUCTO_ID)
GO

/*Esto debajo posiblemente este mal porque debe ser modificado en el der.
Me genera duda que la Fk tenga el mismo nombre que la pk de la entidad a la cual referencia.*/

ALTER TABLE M_AL_CUBO.PRODUCTO_X_VARIANTE_X_COMPRA ADD CONSTRAINT COMPRA_ID FOREIGN KEY (COMPRA_ID) REFERENCES M_AL_CUBO.COMPRA (COMPRA_ID)
GO

--Producto_x_variante

ALTER TABLE M_AL_CUBO.PRODUCTO_X_VARIANTE ADD CONSTRAINT PRODUCTO_ID FOREIGN KEY (PRODUCTO_ID) REFERENCES M_AL_CUBO.PRODUCTO_X_VARIANTE_X_VENTA (PRODUCTO_ID)
GO

ALTER TABLE M_AL_CUBO.PRODUCTO_X_VARIANTE ADD CONSTRAINT TIPO_VARIANTE_ID FOREIGN KEY (TIPO_VARIANTE_ID) REFERENCES M_AL_CUBO.TIPO_VARIANTE (TIPO_VARIANTE_ID)
GO

--Producto_x_variante_x_venta
/*
ojo: chequear la sintxis de "VENTA_ID (VENTA_CODIGO)", estaba asi en el DER y mas arriba en el codigo pero 
no entiendo porque se puso asi
*/

ALTER TABLE M_AL_CUBO.PRODUCTO_X_VARIANTE_X_VENTA ADD CONSTRAINT VENTA_ID (VENTA_CODIGO) FOREIGN KEY (VENTA_ID (VENTA_CODIGO)) REFERENCES M_AL_CUBO.VENTA (VENTA_ID (VENTA_CODIGO))
GO
