...
GO
/*
SELECT VENTA_CODIGO, VENTA_FECHA, PRODUCTO_CODIGO, PRODUCTO_VARIANTE, PRODUCTO_VARIANTE_CODIGO, VENTA_PRODUCTO_CANTIDAD, VENTA_PRODUCTO_PRECIO, VENTA_DESCUENTO_IMPORTE FROM GD_ESQUEMA.MAESTRA WHERE PRODUCTO_CODIGO IS NOT NULL AND VENTA_PRODUCTO_PRECIO IS NOT NULL
	GROUP BY VENTA_CODIGO, VENTA_FECHA, PRODUCTO_CODIGO, PRODUCTO_VARIANTE, PRODUCTO_VARIANTE_CODIGO, VENTA_PRODUCTO_CANTIDAD, VENTA_PRODUCTO_PRECIO, VENTA_DESCUENTO_IMPORTE
	ORDER BY 3, 2 ASC
*//*
SELECT COMPRA_NUMERO, COMPRA_FECHA, PRODUCTO_CODIGO, PRODUCTO_VARIANTE, PRODUCTO_VARIANTE_CODIGO, COMPRA_PRODUCTO_CANTIDAD, COMPRA_PRODUCTO_PRECIO FROM GD_ESQUEMA.MAESTRA WHERE PRODUCTO_CODIGO IS NOT NULL AND COMPRA_PRODUCTO_PRECIO IS NOT NULL
	GROUP BY COMPRA_NUMERO, COMPRA_FECHA, PRODUCTO_CODIGO, PRODUCTO_VARIANTE, PRODUCTO_VARIANTE_CODIGO, COMPRA_PRODUCTO_CANTIDAD, COMPRA_PRODUCTO_PRECIO
	ORDER BY 1
	SELECT * FROM gd_esquema.Maestra*/
CREATE PROCEDURE M_AL_CUBO.MIGRAR_PRODUCTO_X_VARIANTE_X_COMPRA
AS
BEGIN 
	SELECT PRODUCTO_CODIGO, PRODUCTO_VARIANTE FROM GD_ESQUEMA.MAESTRA WHERE PRODUCTO_CODIGO IS NOT NULL
	GROUP BY PRODUCTO_CODIGO, PRODUCTO_VARIANTE
...
/*
	...
	SELECT * FROM gd_esquema.Maestra WHERE VENTA_CODIGO = '121467' AND VENTA_FECHA = '2022-02-06' AND PRODUCTO_VARIANTE_CODIGO = '015HPH1YB6HEBMWAG'
	SELECT VENTA_CODIGO, VENTA_TOTAL FROM gd_esquema.Maestra WHERE VENTA_CODIGO = '121467' AND VENTA_FECHA = '2022-02-06'
	GROUP BY VENTA_CODIGO, VENTA_TOTAL

		SELECT VENTA_FECHA, VENTA_CODIGO, PRODUCTO_CODIGO, PRODUCTO_VARIANTE, PRODUCTO_VARIANTE_CODIGO, VENTA_PRODUCTO_CANTIDAD, VENTA_PRODUCTO_PRECIO FROM GD_ESQUEMA.MAESTRA WHERE PRODUCTO_CODIGO IS NOT NULL AND VENTA_PRODUCTO_PRECIO IS NOT NULL
	GROUP BY VENTA_FECHA, VENTA_CODIGO, PRODUCTO_CODIGO, PRODUCTO_VARIANTE, PRODUCTO_VARIANTE_CODIGO, VENTA_PRODUCTO_CANTIDAD, VENTA_PRODUCTO_PRECIO
	ORDER BY 1*/
